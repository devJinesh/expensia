...
public class SavedTransactionResponseDto {
    private long id;  // Changed from planId to match frontend
    ...
    private LocalDate nextDueDate;  // Added to match frontend
    
    private LocalDate startDate;  // Added to match frontend
}
